...
#             Spectral_Weight(args.n_bands, ch, kernel_size=3, stride=1, padding=1),
#             # nn.Conv2d(args.n_bands,ch,3,padding=1),
...
#             (AdaIN(2,ch) if args.noise else nn.Identity()),
#             nn.LeakyReLU(),
#             nn.Conv2d(ch, args.n_bands, 3, padding=1),
#         )
...
# class SSADSNet(nn.Module):
#     def __init__(self, args):
#         super(SSADSNet, self).__init__()
#         ch = args.GIN_ch
#         self.Spectral_Weight_1 = Spectral_Weight(args.n_bands, ch, kernel_size=3, stride=1, padding=1)
#         self.Spatial_Weight_1 = Spatial_Weight(args.n_bands, ch, kernel_size=3, stride=1, padding=1)
#         # self.Spectral_Weight_1 = Spectral_Weight(args.numComponents, ch, kernel_size=3, stride=1, padding=1)
#         # self.Spatial_Weight_1 = Spatial_Weight(args.numComponents, ch, kernel_size=3, stride=1, padding=1)
#         self.AdaIN = AdaIN(2, ch) if args.noise else nn.Identity()
#         # self.res11 = ResnetBlock(ch, padding_type='zero', norm_layer=nn.BatchNorm2d, use_dropout=False)
#         self.Spectral_Weight_2 = Spectral_Weight(ch, ch, kernel_size=3, stride=1, padding=1)
#         self.Spatial_Weight_2 = Spatial_Weight(ch, ch, kernel_size=3, stride=1, padding=1)
#         # self.res12 = ResnetBlock(ch, padding_type='zero', norm_layer=nn.BatchNorm2d, use_dropout=False)
#         self.Spectral_Weight_3 = Spectral_Weight(ch, ch, kernel_size=3, stride=1, padding=1)
#         self.Spatial_Weight_3 = Spatial_Weight(ch, ch, kernel_size=3, stride=1, padding=1)
#         # self.res13 = ResnetBlock(ch, padding_type='zero', norm_layer=nn.BatchNorm2d, use_dropout=False)
#         self.generate = nn.Conv2d(ch, args.n_bands, 3, padding=1)
#         # self.generate = nn.Conv2d(ch, args.numComponents, 3, padding=1)
#         self.activate = nn.LeakyReLU()
#         # self.bn = nn.BatchNorm2d(ch)
#         self.bn = nn.InstanceNorm2d(ch, affine=False)
...
#         # # self.res21 = ResnetBlock(ch, padding_type='zero', norm_layer=nn.BatchNorm2d, use_dropout=False)
...
#         # # self.res22 = ResnetBlock(ch, padding_type='zero', norm_layer=nn.BatchNorm2d, use_dropout=False)
...
#         # # self.res23 = ResnetBlock(ch, padding_type='zero', norm_layer=nn.BatchNorm2d, use_dropout=False)
...
#         out1 = self.Spectral_Weight_1(x) + self.Spatial_Weight_1(x)
#         out1 = self.activate(self.AdaIN(out1))
#         out1 = self.Spectral_Weight_2(out1) + self.Spatial_Weight_2(out1)
#         out1 = self.activate(self.AdaIN(out1))
#         out1 = self.Spectral_Weight_3(out1) + self.Spatial_Weight_3(out1)
#         out1 = self.activate(self.AdaIN(out1))
#         out1 = self.generate(out1)
#         weight_alpha1 = F.softmax(self.Weight_Alpha, dim=0)
#         out1 = weight_alpha1[0] * x + weight_alpha1[1] * out1

#         out2 = self.Spectral_Weight_1(x) + self.Spatial_Weight_1(x)
#         out2 = self.activate(self.AdaIN(out2))
#         out2 = self.Spectral_Weight_2(out2) + self.Spatial_Weight_2(out2)
#         out2 = self.activate(self.AdaIN(out2))
#         out2 = self.Spectral_Weight_3(out2) + self.Spatial_Weight_3(out2)
#         out2 = self.activate(self.AdaIN(out2))
#         out2 = self.generate(out2)
...
#         # out1 = self.activate1(self.bn1(self.AdaIN1(out1)))
#         # # out1 = self.res13(out1)
#         # out1 = torch.sigmoid(self.generate1(out1))
